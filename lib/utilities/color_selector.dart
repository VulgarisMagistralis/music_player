...
class _SelectorState extends ConsumerState<ColorSelector> {
  Color invert(Color selectedColor) => Color.from(
      alpha: 1,
      red: 1 - selectedColor.r,
      green: 1 - selectedColor.g,
      blue: 1 - selectedColor.b);
        ...
        onTap: () => ColorPicker(
                  ...
                  ColorPickerType.primary: false
                    ...
                    onColorChanged: (Color color) =>
                        ref.read(widget.provider.notifier).update(color),
                ...
                .showPickerDialog(context,
                    shadowColor: invert(selectedColor),
