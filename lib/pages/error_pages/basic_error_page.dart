...
import 'package:music_player/theme/theme_providers.dart' show playerThemeProvider;
...
class BasicErrorPageState<T extends BasicErrorPage> extends ConsumerState<T> {
  ...
  Widget build(BuildContext context) => MaterialApp(
      ...
      home: Scaffold(
        ...
        Text(widget.message, style: const TextStyle(color: Color.fromARGB(255, 171, 35, 35), fontSize: 20), overflow: TextOverflow.visible, softWrap: true),
